...
namespace Odev1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string strName = "Gülçin Taşkın";
            string name = "Gülçin";
            string surname = "Taşkın";
            ...
            string hour = DateTime.Now.ToString("HH:mm");  //Şuanın saat:dk şeklinde verir.
